  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card p-5">
        ...
        <div className="space-y-3">
          {googleConnected ? (
            <div className="flex items-center justify-between p-4 rounded-xl bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-white dark:bg-gray-800 flex items-center justify-center shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <div>
                  <p className="font-medium text-sm text-green-800 dark:text-green-200">Google Account</p>
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 px-1">
            After connecting, refresh the page to update your status.
          </p>
        </div>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-red-200 dark:border-red-900 text-red-500 hover:bg-red-50 dark:hover:bg-red-950/30 font-medium transition-colors"
      >
