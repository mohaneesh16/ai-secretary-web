  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card overflow-hidden">
        <div className="bg-brand-strong dark:bg-surface-overlay h-20" />
        <div className="px-6 pb-6">
          <div className="-mt-10 mb-4">
            <div className="w-20 h-20 rounded-2xl bg-brand-strong border-4 border-surface flex items-center justify-center text-3xl font-bold text-brand-fg shadow-md">
      ...
      <div className="card p-5">
        <p className="text-xs font-semibold uppercase tracking-wider text-fg-muted mb-4">Profile</p>
      ...
      {/* Appearance */}
      <div className="card p-5">
        <p className="text-xs font-semibold uppercase tracking-wider text-fg-muted mb-4">Appearance</p>
      ...
      <div className="card p-5">
        <div className="flex items-center justify-between mb-4">
          <p className="text-xs font-semibold uppercase tracking-wider text-fg-muted">Integrations</p>
        ...
        <div className="space-y-3">
          {googleConnected ? (
            <div className="flex items-center justify-between p-4 rounded-xl bg-positive-subtle border border-positive-subtle">
          ...
          <p className="text-xs text-fg-muted px-1">After connecting, refresh the page to update your status.</p>
        </div>
      </div>

      {/* About */}
      <div className="card p-5">
        <p className="text-xs font-semibold uppercase tracking-wider text-fg-muted mb-4">About</p>
        <div className="space-y-3">
          {[
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="card w-full max-w-sm p-6 text-center">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={handleLogout} className="flex-1 bg-danger hover:opacity-90 text-white font-medium px-4 py-2 rounded-lg transition-colors">Sign Out</button>
            </div>
          </div>
        </div>
      )}
