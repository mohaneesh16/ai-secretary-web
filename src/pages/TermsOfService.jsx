      ...
      <main className="max-w-3xl mx-auto px-6 py-12 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            By creating an account or using Modev Secretary, you agree to these Terms of Service.
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            Modev Secretary is a personal productivity assistant that helps you manage tasks,
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            When you connect your Google account, you authorise Modev Secretary to access your
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            Modev Secretary uses OpenAI to generate briefings, chat responses, and email drafts.
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            Modev Secretary is provided "as is". We are not liable for any indirect, incidental,
